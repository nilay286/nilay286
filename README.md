...
📊 I am a **Data Analyst** with strong hands-on experience in **SQL, Power BI, and Excel**, specializing in **manufacturing, quality, and operational data analysis**.

I work with complex data from systems such as **MES, WMS, and PDKS**, and focus on building **end-to-end analytical solutions** — from data extraction and modeling to interactive dashboards and actionable insights.
